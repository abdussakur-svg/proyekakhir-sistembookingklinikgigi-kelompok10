        ...
        <div class="mb-8 flex justify-between items-center">
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm mt-0.5">
                    Konfirmasi, selesaikan, atau batalkan permintaan janji temu medis pasien di sini.
                </p>
            </div>

            <a href="laporan-booking.php"
                class="bg-blue-600 text-white px-4 py-2 rounded-xl font-bold hover:bg-blue-700">
                                    ...
                                    <td class="py-4 px-6">
                                        ...
                                        <div class="flex items-center justify-center gap-1.5">
                                            ...
                                            <?php if (strtolower($row['status']) != 'selesai') { ?>
                                                ...
                                                <!-- Tombol Setuju -->
                                                <a href="?setuju=<?php echo $row['id_booking']; ?>"
                                                ...
                                                <!-- Tombol Tolak -->
                                                <a href="?tolak=<?php echo $row['id_booking']; ?>"
                                                ...
                                                <!-- Tombol Selesai -->
                                                <a href="?selesai=<?php echo $row['id_booking']; ?>"
                                                    title="Sesi Selesai Medis"
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <span class="px-3 py-1 text-xs font-bold bg-emerald-100 text-emerald-700 rounded-full">
                                                    Sudah Selesai
                                                </span>
